...
namespace DemoApi
{
    public class CustomReportStorageWebExtension : DevExpress.XtraReports.Web.Extensions.ReportStorageWebExtension
    {
        ...
        public override byte[] GetData(string url)
        {
            ...
            try
            {
                using (var reportFile = File.Open(Path.Combine(_reportDirectory, url + FileExtension), FileMode.Open))
        ...
        public override Dictionary<string, string> GetUrls()
        {
            ...
            var urls = Directory.GetFiles(_reportDirectory, "*" + FileExtension)
        ...
        public override void SetData(XtraReport report, string url)
        {
            ...
            using (var reportFile = File.Open(Path.Combine(_reportDirectory, url + FileExtension), FileMode.OpenOrCreate))
            {
